...
The `action` field in the verification request is checked against the agent's registered scopes. Procta uses a predefined scope registry with 16 categories and 60+ scopes covering trading, withdrawals, DeFi, wallet signing, payments, and more.
